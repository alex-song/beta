...
import alex.beta.torrentparser.bencoding.Reader;
import alex.beta.torrentparser.bencoding.Utils;
import alex.beta.torrentparser.bencoding.types.*;
...
public class TorrentParser {
    ...
    private static Torrent parseTorrent(Object o) throws ParseException {
        if (o instanceof BDictionary) {
            ...
            if (infoDictionary == null) {
                throw new ParseException("InfoDictionary is null", 0);
            }
    ...
    /**
     * @param dictionary root dictionary of torrent
     * @return created by: (optional) path and version of the program used to create the .torrent (string)
     */
     ...
     * @return path — suggested filename where the file is to be saved (if one file)/suggested directory path
